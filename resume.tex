...
\begin{center}
    ...
    \href{https://github.com/zamiurratul}{\underline{zamiurratul.github.io}}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computer Science \& Engineering (CGPA: 3.41/4.00)}{Spring 2012 -- Fall 2015}
    \resumeSubheading
      {Notre Dame College}{Dhaka}
      {Higher Secondary School Certificate - Science (GPA: 5.00/5.00)}{Jul. 2009 -- Jun. 2011}
  \resumeSubHeadingListEnd

%-----------ABOUT-----------
\section{About}
{Principal Software Engineer and Team Lead with 9+ years of experience. Proficient in Java, Spring Boot, Oracle, React, Bash, Redis, and Apache Kafka. Successfully delivered scalable solutions with cross-functional teams of 20+ members, consistently meeting deadlines and optimizing performance}
%
